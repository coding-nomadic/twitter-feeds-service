...
import com.tenz.app.config.TwitterConfiguration;
import com.tenz.app.model.Tweet;
import com.tenz.app.producer.callback.BasicCallback;
...
public class TwitterKafkaProducer {
	...
	public TwitterKafkaProducer() {
		// Configure auth
		Authentication authentication = new OAuth1(TwitterConfiguration.CONSUMER_KEY,
				TwitterConfiguration.CONSUMER_SECRET, TwitterConfiguration.ACCESS_TOKEN,
